...
Στοιχεία από Αρχεία:
	...
	--> Κάθε αρχείο:
		...
		--> Είναι αποθηκευμένο σε ένα αρχείο του πραγματικού File System ( στο αρχικά rootdir και καθρεπτίζεται στο mountdir).
  ...
  Αναγνώσεις:
	...
	--> Μία συνοπτική περιγραφή των συναρτήσεων που καλούνται κατά την διάρκεια των αναγνώσεων είναι:
	      ...
	      --> Η readFile() ανοίγει την λίστα με τα blocks του αρχείου και μετακινεί τον δείκτη στο ( offset / 4 KB ) στοιχείο
	          και καλεί την readBlock() με όρισμα το κάθε ID που διαπερνάει. Προφανώς και θα διαβάσει ( si)
